python3 train_rc_longformer.py --model_type bert \
                              ...
                              --train_file $DATA/data/processed_data/for_bert/train_processed_top_row_bert.json \
                              --predict_file $DATA/data/processed_data/for_bert/dev_processed_new_bert.json \
                              --per_gpu_train_batch_size 8 \
                              --max_seq_length 512 \
                              --doc_stride 128 \
                              --threads 8 \
                              --output_dir $DATA/save/bert_large_logits_top/ \
                              --pred_ans_file $DATA/save/bert_large_logits_top/ \
                              --num_train_epochs 5 \
