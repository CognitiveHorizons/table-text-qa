...
#from transformers import TapasTokenizer, TapasModel
from transformers import BertForSequenceClassification,LongformerForSequenceClassification
from transformers import LongformerModel, LongformerTokenizer
from transformers import RobertaTokenizer,RobertaModel
from torch import nn
import torch
    ...
    def __init__(self,args,state_dict=None):
        ...
        if state_dict:
            if self.model_type == "bert":
                ...
                self.model = LongformerForSequenceClassification.from_pretrained('allenai/longformer-base-4096',state_dict=state_dict)
        else:
            if self.model_type == "bert":
