...
import argparse
from datasets.dataset import TableQADatasetQRconcat
...
def main():
    ...
    if args.test:
        ...
        #Load dataset
        train_dataset = TableQADatasetQRconcat(train_data, args.max_seq_len,bert_tokenizer, shuffle=True,ret_labels=True)
        #pickle.dump(train_dataset,open("data/pickles/roberta/train_dataset_ret_labels.pkl","wb"),protocol=4)
        dev_dataset = TableQADatasetQRconcat(dev_data, args.max_seq_len,bert_tokenizer, shuffle=False,ret_labels=True)
       ...
       # print("pickling is done")
        ...
        #data loader to iterate over full dataset
        train_data_loader = DataLoader(train_dataset, batch_size=args.train_batch_size,sampler=sampler,shuffle=True, batch_sampler=None, pin_memory=True)
